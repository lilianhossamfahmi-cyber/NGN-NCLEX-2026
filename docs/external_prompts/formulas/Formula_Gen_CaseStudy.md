# NGN ITEM GENERATION FORMULA: CaseStudy

To generate 25 high-quality **CaseStudy** items, copy and paste the following 4 distinct blocks into your AI Chat window (ChatGPT, Claude, Gemini).
...
*   **File Source**: docs/external_prompts/Golden Prompts/Golden-NGN-Case-Study-6Q.md
...
*   **File Source**: docs/external_prompts/templates/Template_Gen_CaseStudy.md
*   **Action**: 
