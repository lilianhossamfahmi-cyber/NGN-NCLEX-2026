# NGN ITEM GENERATION FORMULA: MultipleResponse

To generate 25 high-quality **MultipleResponse** items, copy and paste the following 4 distinct blocks into your AI Chat window (ChatGPT, Claude, Gemini).
...
*   **File Source**: docs/external_prompts/Golden Prompts/Golden-NGN-MultipleResponse-Item.md
*   **Action**: Open the file above, select all text, copy, and paste it into the chat.
...
*   **File Source**: docs/external_prompts/templates/Template_Gen_MultipleResponse.md
*   **Action**: 
    1. Open the file above.
    2. **CRITICAL**: Change [INSERT TOPIC HERE] to your desired topic (e.g., 'Cardiology', 'Pediatrics').
    3. Select all text, copy, and paste it into the chat.
