# NGN ITEM GENERATION FORMULA: SingleResponse

To generate 25 high-quality **SingleResponse** items, copy and paste the following 4 distinct blocks into your AI Chat window (ChatGPT, Claude, Gemini).
...
*   **File Source**: docs/external_prompts/Golden Prompts/Golden-NGN-SingleResponse-Item.md
...
*   **File Source**: docs/external_prompts/templates/Template_Gen_SingleResponse.md
*   **Action**: 
