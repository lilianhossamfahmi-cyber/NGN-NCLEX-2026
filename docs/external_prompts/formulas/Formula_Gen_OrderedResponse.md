# NGN ITEM GENERATION FORMULA: OrderedResponse

To generate 25 high-quality **OrderedResponse** items, copy and paste the following 4 distinct blocks into your AI Chat window (ChatGPT, Claude, Gemini).
...
*   **File Source**: docs/external_prompts/Golden Prompts/Golden-NGN-OrderedResponse-Item.md
...
*   **File Source**: docs/external_prompts/templates/Template_Gen_OrderedResponse.md
*   **Action**: 
