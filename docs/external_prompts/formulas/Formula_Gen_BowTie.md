# NGN ITEM GENERATION FORMULA: BowTie

To generate 25 high-quality **BowTie** items, copy and paste the following 4 distinct blocks into your AI Chat window (ChatGPT, Claude, Gemini).
...
*   **File Source**: docs/external_prompts/Golden Prompts/Golden-NGN-BowTie-Item.md
...
*   **File Source**: docs/external_prompts/templates/Template_Gen_BowTie.md
*   **Action**: 
