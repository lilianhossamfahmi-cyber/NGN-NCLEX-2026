# NGN ITEM GENERATION FORMULA: Calculation

To generate 25 high-quality **Calculation** items, copy and paste the following 4 distinct blocks into your AI Chat window (ChatGPT, Claude, Gemini).
...
*   **File Source**: docs/external_prompts/Golden Prompts/Golden-NGN-Calculation-Item.md
...
*   **File Source**: docs/external_prompts/templates/Template_Gen_Calculation.md
*   **Action**: 
