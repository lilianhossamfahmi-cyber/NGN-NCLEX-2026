# NGN ITEM GENERATION FORMULA: HotSpot

To generate 25 high-quality **HotSpot** items, copy and paste the following 4 distinct blocks into your AI Chat window (ChatGPT, Claude, Gemini).
...
*   **File Source**: docs/external_prompts/Golden Prompts/Golden-NGN-HotSpot-Item.md
...
*   **File Source**: docs/external_prompts/templates/Template_Gen_HotSpot.md
*   **Action**: 
