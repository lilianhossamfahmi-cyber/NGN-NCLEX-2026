# NGN ITEM GENERATION FORMULA: DropCloze

To generate 25 high-quality **DropCloze** items, copy and paste the following 4 distinct blocks into your AI Chat window (ChatGPT, Claude, Gemini).
...
*   **File Source**: docs/external_prompts/Golden Prompts/Golden-NGN-DropCloze-Item.md
...
*   **File Source**: docs/external_prompts/templates/Template_Gen_DropCloze.md
*   **Action**: 
