# NGN ITEM GENERATION FORMULA: Highlight

To generate 25 high-quality **Highlight** items, copy and paste the following 4 distinct blocks into your AI Chat window (ChatGPT, Claude, Gemini).
...
*   **File Source**: docs/external_prompts/Golden Prompts/Golden-NGN-Highlight-Item.md
...
*   **File Source**: docs/external_prompts/templates/Template_Gen_Highlight.md
*   **Action**: 
