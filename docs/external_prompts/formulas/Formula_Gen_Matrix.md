# NGN ITEM GENERATION FORMULA: Matrix

To generate 25 high-quality **Matrix** items, copy and paste the following 4 distinct blocks into your AI Chat window (ChatGPT, Claude, Gemini).
...
*   **File Source**: docs/external_prompts/Golden Prompts/Golden-NGN-Matrix-Item.md
...
*   **File Source**: docs/external_prompts/templates/Template_Gen_Matrix.md
*   **Action**: 
