...
export const StudentPreviewModal: React.FC<StudentPreviewModalProps> = ({ item: rawItem, onClose }) => {
    ...
    const handleSubmit = () => {
        ...
        if (submitTimeoutRef.current) clearTimeout(submitTimeoutRef.current);
        submitTimeoutRef.current = setTimeout(() => setIsRationaleOpen(true), 800);
    };
                            ...
                            <div style={leftContentStyle} className="tab-animate">
                                ...
                                {activeTab === 'vitals' && (
                                    <div className="p-6 bg-slate-50">
                                        ...
                                        {renderVitals(item.content.clinicalData?.vitals || (item.content as any)?.vitals)}
                                ...
                                {activeTab === 'labs' && (
                                    <div className="p-6">
                                        ...
                                        {renderLabs(item.content.clinicalData?.labs || (item.content as any)?.labs)}
                                    </div>
                                )}
                                {activeTab === 'orders' && (
                        ...
                        <div className="bg-slate-900 border-l border-slate-700 flex flex-col shadow-2xl z-20" style={{
                            ...
                            <div className="expert-scroll" style={{
                                ...
                                <ExpertDashboard
                                    ...
                                    itemDifficulty={(item.content?.rationale as any)?.difficulty || currentQ?.rationale?.difficulty || null}
