# GOLDEN NGN CASE STUDY GENERATOR (v3 - FIXED)
...
```
**NOTE:** 
- `correct` = clinically significant findings requiring action
- `decoys` = normal/irrelevant information (age alone, routine activities)
...
```json
{
  ...
  "rows": [
    { "id": "r1", "text": "Fever with tachycardia", "correctColumnId": "c1" },
    { "id": "r2", "text": "Orthopnea with lower extremity edema", "correctColumnId": "c2" },
    { "id": "r3", "text": "Hypotension with warm skin", "correctColumnId": "c1" },
    { "id": "r4", "text": "Jugular vein distension", "correctColumnId": "c2" },
    { "id": "r5", "text": "Elevated WBC with left shift", "correctColumnId": "c1" },
    { "id": "r6", "text": "Clear lung sounds bilaterally", "correctColumnId": "c3" }
  ],
  "rationale": { ...full_rationale_object... }
}
  ],
...
```json
{
  ...
  "orderedOptions": [
    { "id": "s1", "text": "Ensure airway patency" },
    { "id": "s2", "text": "Establish IV access" },
    { "id": "s3", "text": "Obtain blood cultures" }
  ],
  "rationale": { ...full_rationale_object... }
}
```
...
```json
{
  ...
  "dropdowns": [
    ...
    },
    {
      "id": "d2",
      "options": [
        { "id": "o3", "text": "Hypotension", "isCorrect": true },
        { "id": "o4", "text": "Hypertension" }
      ]
    }
  ],
  "rationale": { ...full_rationale_object... }
...
```json
{
  ...
  "options": [
    { "id": "o1", "text": "Blood pressure improved", "isCorrect": true },
    { "id": "o2", "text": "Lactate level decreased", "isCorrect": true },
    { "id": "o3", "text": "Fever persists" }
  ],
  "rationale": { ...full_rationale_object... }
}
```
...
[//]: # (REVIEW NOTE: v3.1 - Added complete root structure, field mappings, and enhanced validation checklist.)