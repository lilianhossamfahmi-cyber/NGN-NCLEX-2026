...
export async function magicFixItem(item: MasterQuestionItem, instruction: string): Promise<any> {
...
--- CONTEXT ---
Topic: ${(item.metadata as any)?.clientNeeds || 'General Nursing'}
...
`;
    ...
    console.log('[Gemini Client] Response:', text.substring(0, 100) + '...');
