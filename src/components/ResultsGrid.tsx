                            ...
                            >
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '11px', color: '#64748b', background: '#f8fafc', padding: '4px 8px', borderRadius: '4px', marginBottom: '10px', border: '1px solid #f1f5f9' }}>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                                        <span style={{
                                            fontWeight: 700,
                                            color: item.pedagogy?.difficultyLevel && item.pedagogy.difficultyLevel >= 4 ? '#ef4444' : '#64748b',
                                            background: item.pedagogy?.difficultyLevel && item.pedagogy.difficultyLevel >= 4 ? '#fef2f2' : 'transparent',
                                            padding: '0 4px', borderRadius: '2px'
                                        }}>
                                            Lvl {item.pedagogy?.difficultyLevel ?? 3}
                                        </span>
                                    </div>
                                </div>
